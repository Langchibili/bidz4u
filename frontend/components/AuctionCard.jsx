...
// // /auction-items populate cost, since there's no dedicated count field. Town
// // reads item.actTown — that field doesn't exist on auction-item's schema
// // yet (see app/sell/page.jsx's file-level comment #4); this renders nothing
// // until you add it, since item.actTown will just be undefined.
...
// export default function AuctionCard({ item, currencySymbol = 'ZK', onClick }) {
...
//           {formatCurrency(item.actCurrentHighestPriceUsd, currencySymbol)}
//         </Typography>
