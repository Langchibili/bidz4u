...
//   const { livePrice, auctionStatus, auctionEndTime, isUsingFallback, lastEvent } = useSocket(numericItemId, {
...
//       {/* item.actTown doesn't exist on auction-item's schema yet — see
//           app/sell/page.jsx's file-level comment #4. Renders nothing until
//           you add the field, since item.actTown will just be undefined. */}
//       {item.actTown && (
